...
import csv
# UPDATED IMPORTS - Enhanced wine intelligence with JSONL data
...
if __name__ == '__main__':
    print("\n=== AIMEE V2 STARTUP - ENHANCED WINE INTELLIGENCE ===")
    ...
    print("🍷 Aimee V2 with Enhanced Wine Intelligence Ready!")
